...
# Render injects this automatically on every web service
RENDER_EXTERNAL_HOSTNAME = os.environ.get('RENDER_EXTERNAL_HOSTNAME')
if RENDER_EXTERNAL_HOSTNAME:
    ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME)
    # Required by Django 4+ for HTTPS form posts in production
...
# Django 4.2+ way of configuring storage backends
